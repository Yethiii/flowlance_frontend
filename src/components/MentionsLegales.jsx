...
export default function MentionsLegales() {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen p-4 bg-gray-50 dark:bg-gray-900">
      <Card className="max-w-4xl w-full border-none shadow-xl p-8">
        <h1 className="text-3xl font-black mb-6 text-gray-800 dark:text-white border-b pb-4">
          Mentions Légales & Politique de Confidentialité
        </h1>

        <div className="space-y-6 text-gray-600 dark:text-gray-300">
          <section>
            <h2 className="text-xl font-bold text-gray-800 dark:text-white mb-2">1. Édition du site</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-gray-800 dark:text-white mb-2">2. Données Personnelles (RGPD)</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-gray-800 dark:text-white mb-2">3. Politique des Cookies et Stockage Local</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-gray-800 dark:text-white mb-2">4. Propriété Intellectuelle</h2>
            <p>
